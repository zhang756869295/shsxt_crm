...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
		...
		<div class="form-group">
			...
			<input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="密码" id="userPwd" name="userPwd"/>
		</div>
		<div class="form-actions">
			<button  id="submit"  class="btn btn-success uppercase btn-xs btn-block">登录</button>
		</div>
